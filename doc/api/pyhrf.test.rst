...
.. toctree::
   ...
   pyhrf.test.core_test
   pyhrf.test.graphtest
   pyhrf.test.iotest
   pyhrf.test.jdetest
   pyhrf.test.rfir_test
   pyhrf.test.seppotest
   ...
   pyhrf.test.test_parcellation
   pyhrf.test.test_plot
   pyhrf.test.test_rfir
   pyhrf.test.test_sampler
